...
@php
    ...
    $shareHref = route('surveys.show', $survey['id']);
@endphp
<div class="page-app">
    ...
    <div class="row g-4 mb-4 mb-lg-5">
        <div class="col-12 col-md-8 col-lg-6">
            <div class="site-stats-kpi-tile" role="status">
                ...
                <div class="site-stats-kpi-tile__value">{{ $total }}</div>
    ...
    @else
        ...
        <div class="row g-4">
            @foreach($stats['questions'] as $index => $question)
                ...
                @endphp
                <div class="col-lg-6">
                    <article class="site-stats-q-card h-100 d-flex flex-column">
                        ...
                        <div class="mt-auto">
                            @foreach($question['options'] as $option)
                                ...
                                <div class="site-stats-option-row">
